...
* [Which are the participating e-commerce stores?](/e-commerce%20order/about.html#which-are-the-participating-e-commerce-stores)
* [Where can I find the policy details for this initiative?](/e-commerce%20order/about.html#where-can-i-find-the-policy-details-for-this-initiative)
* [What's the difference between E-commerce Order and E-commerce Order Approval mini-apps?](//e-commerce%20order/about.html#whats-the-difference-between-e-commerce-order-and-e-commerce-order-approval-mini-apps)

## 2. Set up corporate billing

* [Can I set up corporate billing on any e-commerce store?](/e-commerce%20order/set%20up%20corporate%20billing.html#can-i-set-up-corporate-billing-on-any-e-commerce-store)
* [Which email address do I use to sign up for an account with e-commerce?](/e-commerce%20order/set%20up%20corporate%20billing.html#which-email-address-do-i-use-to-sign-up-for-an-account-with-e-commerce)
* [How do I set up corporate billing?](/e-commerce%20order/set%20up%20corporate%20billing.html#how-do-i-set-up-corporate-billing)
* [I could not set up corporate billing with my work email. Why?](/e-commerce%20order/set%20up%20corporate%20billing.html#i-could-not-set-up-corporate-billing-with-my-work-email-why)
* [I did not receive a push notification that asks me to authenticate the corporate billing request.](/e-commerce%20order/set%20up%20corporate%20billing.html#i-did-not-receive-a-push-notification-that-asks-me-to-authenticate-the-corporate-billing-request)
* [The app tells me that my corporate billing request has expired.](/e-commerce%20order/set%20up%20corporate%20billing.html#the-app-tells-me-that-my-corporate-billing-request-has-expired)
* [I cannot see the pending corporate billing request in the Accounts page.](/e-commerce%20order/set%20up%20corporate%20billing.html#i-cannot-see-the-pending-corporate-billing-request-in-the-accounts-page)
* [The app tells me that the corporate billing setup was successful, but I do not see the corporate billing account in the Accounts page.](/e-commerce%20order/set%20up%20corporate%20billing.html#the-app-tells-me-that-the-corporate-billing-setup-was-successful-but-i-do-not-see-the-corporate-billing-account-in-the-accounts-page)
* [If I have multiple work profiles, which agency will my corporate billing account be tied to?](/e-commerce%20order/set%20up%20corporate%20billing.html#if-i-have-multiple-work-profiles-which-agency-will-my-corporate-billing-account-be-tied-to)
...
Approval settings are tied to the agency and not the corporate account itself. 
...
* [How do I set up my agency approval settings?](/e-commerce%20order/setting%20agency%20approval%20settings.html#how-do-i-set-up-my-agency-approval-settings)
* [Do I have to set up my agency approval settings every time I set up corporate billing?](/e-commerce%20order/setting%20agency%20approval%20settings.html#do-i-have-to-set-up-my-agency-approval-settings-every-time-i-set-up-corporate-billing)
* [What if I do not set up my agency approval settings at all?](/e-commerce%20order.html#what-if-i-do-not-set-up-my-agency-approval-settings-at-all)
* [I noticed that the cost centre and approving officer are pre-filled. Are those the right values?](/e-commerce%20order/setting%20agency%20approval%20settings.html#i-noticed-that-the-cost-centre-and-approving-officer-are-pre-filled-are-those-the-right-values)
* [What is the difference between auto-routing and manual routing?](/e-commerce%20order/setting%20agency%20approval%20settings.html#what-is-the-difference-between-auto-routing-and-manual-routing)
* [Can I change my agency approval settings after the initial setup?](/e-commerce%20order/setting%20agency%20approval%20settings.html#can-i-change-my-agency-approval-settings-after-the-initial-setup)
* [The app tells me that my cost centre/approving officer is not valid anymore.](/e-commerce%20order/setting%20agency%20approval%20settings.html#the-app-tells-me-that-my-cost-centreapproving-officer-is-not-valid-anymore)
* [Can I have different approval settings for different corporate billing accounts?](/e-commerce%20order/setting%20agency%20approval%20settings.html#can-i-have-different-approval-settings-for-different-corporate-billing-accounts)
...
| Action needed: Send your purchase to your approving officer using DWP Mobile before it expires. | Pending confirmation | Your order has NOT been sent to the AO yet. | [Send the order to the AO](https://mobilefaq.digitalworkplace.gov.sg/e-commerce%20order.html#how-do-i-send-my-order-to-the-approving-officer-for-approval) for approval. |
